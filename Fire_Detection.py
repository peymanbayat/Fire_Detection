...
if app_mode == 'About App':
    ...
    st.markdown("- <h5>Upload the Image and Detect the Fires in Images</h5 /n Each Decimal number shows the Unburned Carbon amount, for example, 0.6 means 60%>",unsafe_allow_html=True)
